                            ...
                            <div class="col-md-7 col-lg-5 px-lg-2 col-xl-4 px-xl-0 px-xxl-3">
                                <div class="input-group" data-placement="left" data-align="top" data-autoclose="true">
                                    <label class="d-block mb-4">
                                        ...
                                        <select
                                            name="course"
                                            class="form-control text-dark border-secondary bg-transparent"
                                            required
                                        >
                                ...
                                <div class="input-group" data-placement="left" data-align="top" data-autoclose="true">
                                    <label class="d-block mb-4" style="color:black;">
                                        ...
                                        <textarea
                                            name="exam_question"
                                            class="form-control border-secondary bg-transparent text-dark"
                                            placeholder=""
                                            required>
                                        </textarea>
                                    </label>
                                ...
                                <div class="input-group" data-placement="left" data-align="top" data-autoclose="true">
                                    <label class="d-block mb-4">
                                        ...
                                        <label class="d-block mb-4">
                                            Is correct
                                            <input type="radio" name="correct_option" value="option_one">
                                        </label>
                                    </label>
                                </div>
